...
declare packages=(
	...
	"grub2" "ssh" "neovim" "steam" "automake" "autoconf"
	"mplayer2" "evince" "firefox/unstable"
	# Python
	"python-pip" "python-dev" "ipython" "python-pip-whl"
	# Cinnamon
	"xserver-xorg" "x11-xserver-utils" "xfonts-base" "xinit" "redshift-gtk"
...
apt-get $APT_OPTIONS remove gnupg \
	&& apt-get update \
	&& apt-get $APT_OPTIONS install gnupg2
